...
class MountParserTestSuite : public testing::Test {
protected:
};

TEST_F(MountParserTestSuite, mount_type) {
    // bind
...
TEST_F(MountParserTestSuite, source_and_destination_of_bind_mount) {
    MountParserChecker{"type=bind,source=/src,destination=/dest"}
        .expectSource("/src")
...
TEST_F(MountParserTestSuite, user_flags_of_bind_mount) {
...
TEST_F(MountParserTestSuite, site_flags_of_bind_mount) {
    // no flags: defaults to recursive, private, read/write mount
    MountParserChecker{"type=bind,source=/src,destination=/dest"}
