...
class DeviceMountTestSuite : public testing::Test {
protected:
};

TEST_F(DeviceMountTestSuite, constructor) {
...
TEST_F(DeviceMountTestSuite, getters) {
    auto testDir = libsarus::PathRAII(
...
TEST_F(DeviceMountTestSuite, performMount) {
    auto testDir = libsarus::PathRAII(
