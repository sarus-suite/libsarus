...
class PasswdDBTestSuite : public testing::Test {
protected:
    PasswdDB passwd{};
...
TEST_F(PasswdDBTestSuite, testRead) {
    // create file
...
TEST_F(PasswdDBTestSuite, testWrite) {
    auto path = libsarus::PathRAII{boost::filesystem::path{"/tmp/test-passwd-file"}};
    const auto& file = path.getPath();
