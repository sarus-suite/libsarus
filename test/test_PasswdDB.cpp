...
class PasswdDBTest : public testing::Test {
protected:
  PasswdDB passwd{};
...
TEST_F(PasswdDBTest, testRead) {
  // create file
  auto path =
      libsarus::PathRAII{boost::filesystem::path{"/tmp/test-passwd-file"}};
  const auto &file = path.getPath();
  std::ofstream of{file.c_str()};
  of << "loginName0:x:1000:1001:UserNameOrCommentField0:/home/dir0" << std::endl
