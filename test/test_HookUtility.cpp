...
TEST_F(HooksUtilityTestGroup, findSubsystemMountPaths) {
    ...
    // single line corresponding to searched entry
    {
        ...
        auto mountinfoContent =
            boost::format(
                "34 25 0:29 %s %s rw,nosuid,nodev,noexec,relatime shared:15 - "
    ...
    // multiple lines with several fs types
    {
        ...
        auto mountinfoContent =
            boost::format(
                "18 41 0:17 / /sys rw,nosuid,nodev,noexec,relatime shared:6 - "
                "sysfs sysfs rw,seclabel\n"
                "19 41 0:3 / /proc rw,nosuid,nodev,noexec,relatime shared:5 - "
                "proc proc rw\n"
                "36 25 0:31 / /sys/fs/cgroup/cpu,cpuacct "
                "rw,nosuid,nodev,noexec,relatime shared:17 - cgroup cgroup "
                "rw,cpuacct,cpu\n"
    ...
    // no line corresponding to searched entry
    {
        auto mountinfoContent = boost::format(
            "18 41 0:17 / /sys rw,nosuid,nodev,noexec,relatime shared:6 - "
            "sysfs sysfs rw,seclabel\n"
            "19 41 0:3 / /proc rw,nosuid,nodev,noexec,relatime shared:5 - proc "
            "proc rw\n"
            "36 25 0:31 / /sys/fs/cgroup/cpu,cpuacct "
            "rw,nosuid,nodev,noexec,relatime shared:17 - cgroup cgroup "
            "rw,cpuacct,cpu\n"
            "49 41 253:2 / /home rw,relatime shared:31 - xfs /dev/mapper/home "
