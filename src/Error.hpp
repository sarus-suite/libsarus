...
class Error : public std::exception {
  ...
  public:
    ...
    const char *what() const noexcept override {
        // Return the 'what()' of the original exception that generated this
        // error trace as if the original exception was propagated directly up
        // to the current stack frame, i.e. without intermediate catch-rethrows.
...
inline bool operator==(const Error::ErrorTraceEntry &lhs,
    ...
    return lhs.errorMessage == rhs.errorMessage &&
           lhs.fileName == rhs.fileName && lhs.fileLine == rhs.fileLine &&
